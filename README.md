...
| 4 | CI/CD | Applies (workflows under `.github/workflows/`) | This README's build/verify description; `.github/rulesets/` (live branch protection plus active `v*` release-tag protection; the stronger proposed main-branch export remains unapplied) |
