...
| Ship jurisdiction letter-framing growth (candidate #12) first | Rejected for *this* change: #12 is filed as issue #207 and labeled **good first issue**. Contributor growth is an open roadmap exit criterion (workstream D) with the newcomer inventory deliberately stocked; consuming a reserved onboarding issue to save a maintainer an afternoon is a bad trade. #11 is higher-value on the plan's own scoring anyway. |
